...
module.exports = function(RED) {
    ...
    function moonNodeCommandNode(n) {
        ...
        var failedCMD = function(e, msg) {
            if (typeof msg.moonNode !== "undefined"){
                msg.moonNode.cmdSent = "ERROR: No Moonraker server defined, or cannot connect. Command has not been sent! error = " + e;
            } else {
                msg.moonNode = {cmdSent: "ERROR: No Moonraker server defined, or cannot connect. Command has not been sent! error = " + e};
            }
            node.send(msg);
